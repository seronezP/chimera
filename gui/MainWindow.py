...
class App:
    def __init__(self, launch_callback):
        ...
        self.entry_1 = customtkinter.CTkEntry(
            self.main_frame, placeholder_text="Enter Your Name", width=120, height=30
        )
        ...
        self.combobox = customtkinter.CTkComboBox(
            self.main_frame, width=120, height=30, variable=self.combobox_var
        )
        ...
        self.settings_gui = SettingsGUI(
            self.app, self.hide_settings, self.minecraft_path, width=500, height=300
        )
